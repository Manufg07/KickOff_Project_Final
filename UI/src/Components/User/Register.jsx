...
const Register = () => {
  return (
    ...
    <div style={{ backgroundImage: `url(${Bg})` }} className=" bg-cover bg-gray-100 flex items-center justify-center min-h-screen ">
        <div className="text-center fixed top-4 mr-30 w-full">
        ...
        <div  className= "bg-transparent p-6 rounded-lg shadow-lg w-full max-w-md mr-auto ml-6 mt-24 border-2 border-gray-300">
            ...
            <form action="#" method="POST">
                ...
                <a href="User_Login.html"><button type="submit" className="w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Register</button></a>
            </form>
            <a className="text-white ml-80 mt-96 underline" href="User_Login.html">Login</a>
        </div>
    </div>
    </>
  )
