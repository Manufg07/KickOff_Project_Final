...
// import img from '../../src/assets/Land.jpeg'
import '../App.css'
...
const MainLandingPage = () => {
  ...
  return (
    <>
    <motion.div className="container bg-custom bg-white dark:bg-black flex items-center w-screen h-screen p-5" ref={constraintsRef}>
    <motion.div 
    className="item"
    ...
    <span className="text-6xl font-semibold dark:text-black ">Kick</span>
      ...
      {/* <span className="text-6xl font-semibold dark:text-black bounce-3d">T</span> */}
      <span className="text-6xl font-semibold text-orange-500 bounce-3d">ff</span>
      </div>
        <div className="mt-4 text-blue-500 dark:text-pink-600 text-center">
          <p className="text-xl font-medium">Welcome to Kickoff!</p>
          <p className="text-md">Choose your login to continue.</p>
        </div>
        <div className="mt-8 flex justify-center space-x-4">
          <button
            onClick={handleAdminLogin}
            className="px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-75 transition-transform transform hover:-translate-y-1"
          >
            Admin Login
          </button>
          <button
